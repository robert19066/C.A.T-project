...
def help():
    print(
        ...
        changeFolder [path] - Change directory to the specified path.The .. works as well.

        =============================================================================================================================

        list - List directory contents.Works like the dir command in windows,or ls in unix-like systems.
        or lst
        ...
        run [command] - Run the specified command in the shell(windows).

        =============================================================================================================================

        copyTo [path] [filepath] - Copy the file to the specified path.is xcopy from windows btw.
...
if showSplashScreen:print(r"""
   ...
   _____           _______   ______    _                 _   _               ______    _ _ _   _             
  / ____|     /\  |__   __| |  ____|  | |               | | (_)             |  ____|  | (_) | (_)            
 | |         /  \    | |    | |__   __| |_   _  ___ __ _| |_ _  ___  _ __   | |__   __| |_| |_ _  ___  _ __  
 | |        / /\ \   | |    |  __| / _` | | | |/ __/ _` | __| |/ _ \| '_ \  |  __| / _` | | __| |/ _ \| '_ \ 
 | |____ _ / ____ \ _| |    | |___| (_| | |_| | (_| (_| | |_| | (_) | | | | | |___| (_| | | |_| | (_) | | | |
  \_____(_)_/    \_(_)_|    |______\__,_|\__,_|\___\__,_|\__|_|\___/|_| |_| |______\__,_|_|\__|_|\___/|_| |_|
                                                                                                             
                                                                                                             

      
                                   Welcome to WinC.A.T (Windows Comand Execution Tool) Education edition
      
 """)
else:
    print("                        Welcome to WinC.A.T (Windows Comand Execution Tool) Education edition"        )
